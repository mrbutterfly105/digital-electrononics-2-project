 ...
 * Purpose:  Turn off pump connected to pin PB0. Changes mode of pin PB0 to output and sets its value to digital 0. 
 * Input(s): None
 * Returns:  None
 **********************************************************************/
void pumpTurnOff() {
...
/**********************************************************************
 * Function: pumpTurnOn()
 * Purpose:  Turn on pump connected to pin PB0. Changes mode of pin PB0 to output and sets its value to digital 1. 
 * Input(s): None
 * Returns:  None
 **********************************************************************/
void pumpTurnOn() {
